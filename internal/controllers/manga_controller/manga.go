...
func GetMangaLatest(c *gin.Context) {
	...
	mangas, err := manga_scrapper.GetHome(c.Request.Context(), queryParams)
	if err != nil {
...
func GetMangaDetail(c *gin.Context) {
	...
	manga, err := manga_scrapper.GetDetail(c.Request.Context(), queryParams)
	if err != nil {
		logrus.WithContext(c.Request.Context()).Error(err)
		render.ErrorResponse(c.Request.Context(), c, err, false)
		return
...
func ReadManga(c *gin.Context) {
	...
	chapter, err := manga_scrapper.GetChapter(ctx, queryParams)
	if err != nil {
...
func SearchManga(c *gin.Context) {
	...
	mangas, err := manga_scrapper.GetSearch(c.Request.Context(), queryParams)
	if err != nil {
		logrus.WithContext(c.Request.Context()).Error(err)
		render.ErrorResponse(c.Request.Context(), c, err, false)
		return
